...
export const card =
  'rounded-2xl border border-stone-200/80 bg-white/78 shadow-xs backdrop-blur transition-all hover:border-teal-300/70 hover:shadow-md hover:shadow-teal-500/5 dark:border-stone-800 dark:bg-stone-900/90 dark:hover:border-teal-700/50';
...
export const btnPrimary =
  'rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-teal-600/25 transition-all hover:-translate-y-0.5 hover:from-teal-400 hover:to-emerald-500 hover:shadow-xl hover:shadow-teal-500/30 active:translate-y-0 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 dark:shadow-teal-500/15';

export const btnPrimaryFlat =
  'rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-teal-600/25 transition-all hover:from-teal-400 hover:to-emerald-500 hover:shadow-xl hover:shadow-teal-500/30 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 dark:shadow-teal-500/15';
